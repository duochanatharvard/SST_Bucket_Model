function [SST_out,Budget] = BKT_MD_STP_2_MD_WOODEN_GRD(true_SST,true_AT,e_air,u_environment,s_environment,Cs,direct_ratio,deck_time,solar_shading,zenith_angle)
